...
StylePascalCase = "ModernPython" # for class name declataration
style_snake_case = "Modern_Python" # for variable names and functions
STYLEUPPERCASE = "I don't wanna change" # for constants
